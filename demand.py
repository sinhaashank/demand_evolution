...
# Add figure title
fig.update_layout(
    title_text="EU Power Demand" + "<br><sup>Weekly Evolution </sup>",
    plot_bgcolor="#FFF",  # Sets background color to white,
    )

# Set axes titles
fig.update_yaxes(title_text="Load (MW)", title_font = dict(size = 12), linecolor = "#BCCCDC", showgrid=False)
fig.update_xaxes(dtick = 5, linecolor = "#BCCCDC", showgrid=False)

outfile = 'EU_demand_evl'+'.html'
